...
class UniformAffineQuantizer(nn.Module):
    def __init__(
        ...
        if lwc:
            ...
            self.register_parameter('upbound_factor', nn.Parameter(torch.ones((dim1, 1), device='cuda') * init_value))
            self.register_parameter('lowbound_factor', nn.Parameter(torch.ones((dim1, 1), device='cuda') * init_value))
