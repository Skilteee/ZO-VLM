...
from llava.models.int_opt_layer import QuantOPTDecoderLayer, QuantOPTAttention
from llava.models.int_llama_layer import QuantLlamaDecoderLayer
from llava.quantize.int_linear import QuantLinear
from llava.quantize.utils import smooth_and_quant_temporary, use_parameters, clear_temp_variable
...
class LLaVATrainer(Trainer):
    ...
    def _inner_training_loop(
        ...
        self.w_eval_bits = 16
        self.a_eval_bits = 16
        self.w_train_bits = 16
        self.a_train_bits = 16
        self.args.isllama = True

        self.args.model_nick_name = 'Llama-2-7b-hf'
        ...
        #                                                                                            dtype=weight.dtype)
        #                     else:
        #                         shift = torch.zeros_like(scale, device=weight.device, dtype=weight.dtype)
        #
        ...
        for name, param in model.named_parameters():
            if param.requires_grad:
                ...
                if 'scale' not in name and 'shift' not in name and 'bound' not in name and 'mm_projector' not in name:
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if step % args.gradient_accumulation_steps == 0:
                    ...
                    if self.state.global_step % log_step == 0:
                        print(
                            {'loss': round(np.mean(self.loss_list[-10:]), 4), 'epoch': epoch,
